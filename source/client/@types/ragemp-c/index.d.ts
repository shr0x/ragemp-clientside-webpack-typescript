...
interface EntityMp {
	...
	getBoneIndex( boneName: any ): number;
...
interface ObjectMp extends EntityMp {
	...
	placeOnGroundProperly2(): boolean;
...
interface VehicleMp extends EntityMp {
	...
	setSirenSound( arg0: boolean ): void;
	setInteriorlight( status: any ): void;
	...
	getEntryPositionOfDoor( doorIndex: integer ): Vector3Mp;
...
interface GameGraphicsMp {
	...
	drawMarker( type: number, posX: number, posY: number, posZ: number, dirX: number, dirY: number, dirZ: number,
		...
		rotate: boolean, textureDict: any, textureName: any, drawOnEnts: boolean ): void;
...
interface AttachMpPool {

	attachments: any;
	addFor( entity: EntityMp, id: number ): void;
	removeFor( entity: EntityMp, id: number ): void;
	initFor( entity: EntityMp ): void;
	shutdownFor( entity: EntityMp ): void;
	register( id: any, model: any, boneName: any, offset: any, rotation: any, collision: boolean, freeze: boolean ): void;
	unregister( id: number ): void;

	addLocal( name: any ): void;
	removeLocalAll(): void;
	removeLocal( name: any ): void;
	getAttachments(): void;
